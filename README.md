...
BuddyBuild has been set up with the project to perform builds and run tests automatically on any commit. The latest build status is displayed as the top of this readme.
